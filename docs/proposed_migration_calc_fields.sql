-- ─────────────────────────────────────────────────────────────────────────────
-- PROPOSED (DRAFT) — Phase 2 calc data-model fields
-- ─────────────────────────────────────────────────────────────────────────────
-- Status: NOT YET APPLIED. This file is intentionally kept OUT of
--         supabase/migrations/ so the manual migration loop cannot pick it up.
--         When approved, move it to supabase/migrations/024_calc_fields.sql
--         (next free number after 023) and run it.
--
